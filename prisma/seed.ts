...
async function main() {
  ...
  const models: ModelDef[] = [
    ...
    { modelId: "gemini-2.0-flash",         displayName: "Gemini 2.0 Flash",           category: "multimodal", maxContext: 1000000, ...t1 },
    { modelId: "gemini-2.0-flash-lite",    displayName: "Gemini 2.0 Flash Lite",      category: "multimodal", maxContext: 1000000, ...t1 },
    ...
    { modelId: "deepseek/deepseek-v3.1-terminus-thinking", displayName: "DeepSeek V3.1 Terminus Thinking", category: "reasoning", maxContext: 64000, ...t2 },
    ...
    { modelId: "deepseek/deepseek-v3.2-exp-thinking",     displayName: "DeepSeek V3.2 Exp Thinking",      category: "reasoning", maxContext: 64000, ...t2 },
    ...
    { modelId: "qwen2.5-vl-72b-instruct",         displayName: "Qwen2.5 VL 72B",           category: "multimodal", maxContext: 32000, ...t2 },
    { modelId: "qwen2.5-vl-7b-instruct",          displayName: "Qwen2.5 VL 7B",            category: "multimodal", maxContext: 32000, ...t1 },
    ...
    { modelId: "moonshotai/kimi-k2-thinking", displayName: "Kimi K2 Thinking", category: "reasoning", maxContext: 128000, ...t3 },
