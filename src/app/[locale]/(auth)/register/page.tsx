    ...
    <div className="flex min-h-screen items-center justify-center bg-[#F9F8F6] px-4">
      ...
      >
        <div className="mb-8 text-center">
          ...
          <h1 className="font-heading mt-6 text-2xl font-bold text-foreground">{t("registerTitle")}</h1>
        ...
        <div className="mt-6 text-center text-sm text-muted-foreground">
          {t("hasAccount")}{" "}
          <Link href="/login" className="font-medium text-primary hover:text-accent-brand-hover">
            {t("loginButton")}
          </Link>
        </div>
      </motion.div>
